...
> Portions of this code were incorporated and adapted with permission from [Omics Breadcrumbs](https://gitlab.com/oasci/omics) by OASCI licensed under the [MIT license](https://gitlab.com/oasci/breadcrumbs/cadd/-/blob/main/LICENSE_CODE.md).
